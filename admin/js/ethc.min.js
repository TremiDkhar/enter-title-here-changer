...
(function () {
  ...
  var postType = document.getElementById('post-type'),
      ...
      deleteLinks = document.querySelectorAll('.ethc-wrap .delete a'); // Add event listener to all the edit link.
  ...
  function handleEditLink(e) {
    ...
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
      ...
      inputLabel: "for ".concat(e.target.getAttribute('data-post-type')),
      input: 'text',
      ...
      if (confirm.isConfirmed) {
        ...
        request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8'); // @todo Add nonce

        var query = "action=ethc_handle_add_placeholder&post-type=".concat(e.target.getAttribute('data-post-type'), "&placeholder=").concat(confirm.value, "&ethc-action=edit&ajax=1&ethc-placeholder-nonce=").concat(ETHC.ethc_nonce);
        request.send(query);
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
  ...
  function handleDeleteLink(e) {
    ...
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
      ...
      if (confirm.isConfirmed) {
        ...
        var query = "action=ethc_handle_delete_placeholder&post-type=".concat(e.target.getAttribute('data-post-type'), "&ethc-action=delete&ajax=1&ethc-placeholder-nonce=").concat(ETHC.ethc_nonce);
        request.send(query);
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./admin/js/script.js");
